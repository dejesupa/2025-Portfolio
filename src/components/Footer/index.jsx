...
export default function Footer() {
  ...
  // actual values typed into the form
  ...
  // used only for the underline animation
  ...
  const timeoutAlert = () =>
    setTimeout(() => {
      setSendStatus((prev) => ({ ...prev, processed: false }))
    }, 5000)
  ...
  return (
    <footer ref={ref} className="footer" id="contact">
          ...
          {inputFields.map((field, index) => (
            ...
            >
              ...
              >
                <motion.div
                  initial="hidden"
                  animate={touchedFields[field.stateKey] && "visible"}
                  variants={inputFieldLineVariant}
                  transition={{
                    type: "spring",
                    stiffness: 20,
      ...
      >
        <p>Copyright © {new Date().getFullYear()} Trisha de Jesus</p>
        <p>
          <Time delay={3} />
        </p>
        <p></p>
